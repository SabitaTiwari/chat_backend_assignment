...
DATABASE_URL = "postgresql+psycopg2://postgres:Newjob#613@localhost:5432/chat_app_db"
...
Authentication Flow
Sign up a user using /auth/signup
Log in using /auth/login
...
This returns older messages with IDs less than the cursor.
...
For assignment/demo purposes, signup accepts a role field. In a production system, admin creation would normally be restricted.
Testing
